namespace Example.OAuth
{
	...
	public class OauthHelperUtility
	{
		// TODO: When/if framework allows - call these methods in framework instead of these helper methods
		...
		/// </remarks>
		public static void AppendQueryArgs(UriBuilder builder, IEnumerable<KeyValuePair<string, string>> args)
		{
		...
		public static string CreateQueryString(IEnumerable<KeyValuePair<string, string>> args)
		{
			...
			{
				Validation.Verify.Operation(!string.IsNullOrEmpty(p.Key), "Unexpected null or empty key");
				Validation.Verify.Operation(p.Value != null, "Unexpected null value");
